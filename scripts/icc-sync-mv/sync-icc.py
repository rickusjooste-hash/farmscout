"""
ICC Irrigation Data Sync — Mouton's Valley
===========================================
...
FARM_ID      = '1a52f7f3-aeab-475c-a6e9-53a5e302fddb'  # Mouton's Valley
ICC_DATA_DIR = r'C:\ProgramData\IccWaterControl\ICCPRO\Artifact'
...
def _find_latest_xls():
    pattern = os.path.join(ICC_DATA_DIR, 'Report_*.xls')
...
def sync(filepath=None):
    log.info("=" * 50)
    log.info("Starting ICC sync — Mouton's Valley")
