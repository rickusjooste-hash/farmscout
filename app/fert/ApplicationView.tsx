      ...
      <div style={s.prescribedBox}>
        ...
        {hasBags && prescribedBags != null && (
          <div style={{ ...s.prescribedRow, borderTop: '1px solid #2e5a2e', marginTop: 4, paddingTop: 8 }}>
            ...
            <span style={{ ...s.prescribedValue, color: '#ffd54f' }}>{prescribedBags} bags ({line.bag_weight_kg} kg each)</span>
          </div>
        )}
        {spreaderOpening && (
          <div style={{ ...s.prescribedRow, borderTop: '1px solid #2e5a2e', marginTop: 4, paddingTop: 8 }}>
            <span style={s.prescribedLabel}>Spreader opening</span>
            <span style={{ ...s.prescribedValue, color: '#6fcf6f', fontSize: 24, fontWeight: 800 }}>{spreaderOpening.opening.toFixed(1)}</span>
          </div>
        )}
      </div>
...
const s: Record<string, React.CSSProperties> = {
  ...
  infoLabel: { fontSize: 11, color: '#b0d0b0', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 700 },
  infoValue: { fontSize: 16, fontWeight: 700, color: '#f0f0e0', marginTop: 2 },
  prescribedBox: {
    margin: '16px 20px 0',
    padding: '14px 16px',
    background: '#1e3a1e',
  ...
  prescribedLabel: { fontSize: 14, color: '#b0d0b0', fontWeight: 600 },
  prescribedValue: { fontSize: 15, fontWeight: 700, color: '#f0f0e0' },
  section: {
    padding: '16px 20px 0',
  },
  label: {
