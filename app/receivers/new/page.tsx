  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#eae6df', fontFamily: 'Inter, sans-serif' }}>
      ...
      <main style={{ flex: 1, padding: '32px 40px', maxWidth: 640 }}>
        {created ? (
          <div style={st.card}>
            <h2 style={st.title}>Receiver Created</h2>
            <p style={st.subtitle}>
              {created.full_name} can now log into the BinsApp. Share these credentials:
            </p>
          ...
          <>
            <h1 style={st.pageTitle}>New Receiver</h1>
            <p style={st.pageSub}>Create login credentials for a bins receiver (packhouse clerk).</p>
              ...
              <form onSubmit={handleSubmit}>
                <div style={st.field}>
                  ...
                  <input
                    ...
                    placeholder="e.g. Anita de Bruyn"
                    required
                    style={st.input}
                  />
                </div>
                ...
                <div style={st.field}>
                  ...
                  <input
                    ...
                    placeholder="e.g. anita@farm.co.za"
                    required
                    style={st.input}
                  />
                </div>
                ...
                <div style={st.field}>
                  ...
                  <input
                    ...
                    placeholder="Share this with the receiver"
                    required
                    style={st.input}
                  />
                </div>
                ...
                <button type="submit" disabled={submitting} style={st.submitBtn}>
                  {submitting ? 'Creating receiver...' : 'Create Receiver'}
                </button>
              </form>
            </div>
          </>
